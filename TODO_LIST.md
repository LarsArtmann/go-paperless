...
| Task                                                                             | Status    | Impact | Effort | Evidence                                                                                                                                                                                                    |
| -------------------------------------------------------------------------------- | --------- | ------ | ------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| T18: integration test scaffold (`//go:build integration`)                        | 🟢 `DONE` | Med    | ~3h    | Env-driven (`PAPERLESS_URL`/`PAPERLESS_TOKEN`), skip-if-unset, upload → poll → reconcile e2e (`docs/status/…15-39….md` f-18); suite is httptest-only otherwise                                              |
