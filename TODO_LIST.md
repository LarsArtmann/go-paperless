...
| -------------------------------------------------------------------------------------------------------------------------------- | ------------ | ------ | ------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Build `paperlesstest/` consumer testing SDK (stateful fake server, fixtures, fault injection, round-trip-verified); then migrate InboxClean's two hand-rolled fakes + bank-sync | 🟡 `IN_PROGRESS` | High   | ~4h left | Fake is COMPLETE (server, fixtures, scripting, faults, assertions, docs — all gates green, see `paperlesstest/README.md`); remaining: release cut + InboxClean/bank-sync migrations + pin bumps. Full plan: `docs/planning/2026-09-23_16-19_paperlesstest-consumer-testing-sdk.md` |
