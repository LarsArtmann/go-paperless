...
| Audit ci.yml: confirm govulncheck + fuzz coverage, add what's missing                                                            | 🔴 `TODO`    | Med    | ~30min | ci.yml gained edits 2026-09-16, not audited (`docs/status/2026-09-16_17-35_dependency-upgrade-status.md` §f-10/17)                                                                                                   |
| Run `nix flake check --all-systems` once; resolve the omitted-systems warning                                                    | 🔴 `TODO`    | Low    | ~10min | Check warns aarch64-darwin/aarch64-linux/x86_64-darwin omitted (`docs/status/2026-09-16_17-35_dependency-upgrade-status.md` §f-11)                                                                                   |
| Verify `GOEXPERIMENT=jsonv2,simd` — is `simd` still current on go1.27? Drop if not                                               | 🔴 `TODO`    | Low    | ~15min | flake.nix `goExperiment` (`docs/status/2026-09-16_17-35_dependency-upgrade-status.md` §f-16)                                                                                                                         |
